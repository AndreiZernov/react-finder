  ...
  return (
     <Row className="justify-content-between  mx-1">
       <Col lg={6} border="secondary" bg="dark" as={Card} className="mx-auto d-flex flex-column mb-3" >
         ...
         <div className="card bg-secondary border-secondary rounded-circle m-auto" style={{height:"120px", width: "120px", overflow:'hidden'}}>
           <Form.Control
             className="d-none"
             type="file"
             ref={imageUploader}
           ...
           />
           <img onClick={() => imageUploader.current.click()} ref={uploadedImage} src={user ? user.picture : require(`../../images/account.png`)} style={{width: "100%", margin:"auto"}} alt="Account" className="text-center"></img>
         </div>
         <Form onSubmit={handleSubmit}>
           <div onClick={() => setInputAllow(true)}>
             ...
             />
             <p
               className={inputAllow ? "d-none text-center h5 p-2" : "text-center h5 p-2"}
                 >
