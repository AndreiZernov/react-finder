            ...
            pick =>
              data.hasOwnProperty(pick.split("-")[1]) && (
                <TableSample
                  ...
                  data={AccountItemConverter(pick)}
                  handleClick={handleClick}
                  AccountItemConverter={AccountItemConverter}
                />
              )
          )}
              ...
              pick =>
                data.hasOwnProperty(pick.parent1) && (
                  <TableSample
                    ...
                    data={pick}
                    handleClick={handleClick}
                    removeNewCourses={removeNewCourses}
                  />
                )
            )}
        </tbody>
  ...
  <tr key={data.id}>
    <td style={{ verticalAlign: "middle" }}>
      <img
        ...
        src={require(`../../images/${data.parent1}.${
          data.parent2 === "coursesData" ? "png" : "svg"
        }`)}
        alt={data.parent1}
      />
    </td>

    {data.parent2 === "coursesData" && (
      <td style={{ verticalAlign: "middle" }}>{data.author}</td>
    )}
