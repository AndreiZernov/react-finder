  ...
  return (
    ...
    >
      <Modal.Body className="bg-dark rounded">
        ...
        <Button
          className="text-align-right mt-2 btn btn-danger"
          onClick={onHide}
        >
          Close
        </Button>
            ...
            <Card.Body>
              ...
              >
                <Form.Group controlId={recForm.validation}>
                  {recForm.validation === "validation3" && (
                    <div className="my-1 d-inline">
                      <Form.Check
                        ...
                        value="free"
                      />
                      <label className="px-2 d-inline" htmlFor="free">
                        Free
                      </label>
                      <Form.Check
                        required
                        ...
                        value="paid"
                      />
                      <label className="px-2 d-inline" htmlFor="paid">
                        Paid
                      </label>
                    </div>
                  )}
                  ...
                  {status === "SUCCESS" ? (
                    <p className="text-success h5 my-2">Thanks!!!</p>
                  ) : (
                    <Button
